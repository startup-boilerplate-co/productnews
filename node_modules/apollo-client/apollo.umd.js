(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('whatwg-fetch'), require('graphql-tag/bundledPrinter'), require('redux'), require('graphql-anywhere'), require('symbol-observable')) :
	typeof define === 'function' && define.amd ? define(['exports', 'whatwg-fetch', 'graphql-tag/bundledPrinter', 'redux', 'graphql-anywhere', 'symbol-observable'], factory) :
	(factory((global.apollo = global.apollo || {}),null,global.graphqlTag_bundledPrinter,global.redux,global.graphqlAnywhere,global.$$observable));
}(this, (function (exports,whatwgFetch,graphqlTag_bundledPrinter,redux,graphqlAnywhere,$$observable) { 'use strict';
...
function printRequest(request) {
    return __assign({}, request, { query: graphqlTag_bundledPrinter.print(request.query) });
}
    ...
    if (isQueryResultAction(action)) {
        ...
        if (!constAction.result.errors) {
            ...
            if (constAction.update) {
                ...
                var proxy_1 = new TransactionDataProxy(newState_3, config.dataIdFromObject);
...
var Deduplicator = (function () {
    ...
    Deduplicator.prototype.getKey = function (request) {
        return graphqlTag_bundledPrinter.print(request.query) + "|" + JSON.stringify(request.variables) + "|" + request.operationName;
    };
    return Deduplicator;
}());
...
var QueryManager = (function () {
    function QueryManager(_a) {
        var networkInterface = _a.networkInterface, store = _a.store, reduxRootSelector = _a.reduxRootSelector, _b = _a.reducerConfig, reducerConfig = _b === void 0 ? { mutationBehaviorReducers: {} } : _b, _c = _a.addTypename, addTypename = _c === void 0 ? true : _c, _d = _a.queryDeduplication, queryDeduplication = _d === void 0 ? false : _d;
        var _this = this;
        this.idCounter = 1;
        this.networkInterface = networkInterface;
    ...
    QueryManager.prototype.mutate = function (_a) {
        ...
        var mutationString = graphqlTag_bundledPrinter.print(mutation);
        var request = {
            query: mutation,
            variables: variables,
    ...
    QueryManager.prototype.fetchQuery = function (queryId, options, fetchType, fetchMoreForQueryId) {
        ...
        var queryString = graphqlTag_bundledPrinter.print(queryDoc);
        var storeResult;
...
var ApolloClient$1 = (function () {
    function ApolloClient(options) {
        ...
        var networkInterface = options.networkInterface, reduxRootSelector = options.reduxRootSelector, initialState = options.initialState, dataIdFromObject = options.dataIdFromObject, _a = options.ssrMode, ssrMode = _a === void 0 ? false : _a, _b = options.ssrForceFetchDelay, ssrForceFetchDelay = _b === void 0 ? 0 : _b, _c = options.addTypename, addTypename = _c === void 0 ? true : _c, customResolvers = options.customResolvers, connectToDevTools = options.connectToDevTools, _d = options.queryDeduplication, queryDeduplication = _d === void 0 ? true : _d;
    ...
    ApolloClient.prototype.initProxy = function () {
        if (!this.proxy) {
            this.initStore();
            this.proxy = new ReduxDataProxy(this.store, this.reduxRootSelector || defaultReduxRootSelector);
        }
        return this.proxy;
    };
    return ApolloClient;
...
exports.printAST = graphqlTag_bundledPrinter.print;
